...
function AddSongModal() {
  ...
  const handleAddSong = () => {
    axios
      .post(`http://localhost:5000/addsong_admin`, {
    ...
    <React.Fragment>
      <div className="flex jusitfy-center">
        <button
          ...
          className="mx-4 mb-4 text-xl text-center w-full h-12 rounded-md bg-green-500 active:bg-green-900 text-white"
        >
          Submit
        </button>
      </div>
        ...
        >
          <div className="min-h-screen px-4 text-center">
            ...
            <div className="inline-block w-full max-w-md p-6 my-8 overflow-hidden text-left align-middle transform bg-white shadow-xl rounded-2xl">
              ...
              <div className="mt-2">
                <p className="text-sm text-gray-500">Do you want save song?</p>
              </div>
